...
// 2. Remove the module-level renderStep4Blocks (it's defined inside Dashboard correctly)
...
export default function Dashboard() {
  // 🚀 Place INITIAL_PAGE_DATA here, inside the component
  ...
  // 🚀 Local renderStep4Blocks inside Dashboard (has access to all state and handlers)
